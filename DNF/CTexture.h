...
public:
    ...
    void Render(Vec2D _RenderOffset = Vec2D(0, 0), float _angle = 0.f, bool bCameraFallow = false);
    void DirectRender(Vec2D _RenderOffset = Vec2D(0, 0), float _angle = 0.f, bool bCameraFallow = false);
